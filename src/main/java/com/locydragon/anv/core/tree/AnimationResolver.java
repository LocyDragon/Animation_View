...
public class AnimationResolver {
	public static final Vector<String> runningPlayers = new Vector<>();
	public static final ReentrantLock lock = new ReentrantLock();

	public static boolean resolveAnimation(final AnimationObject object, final Player who) {
		...
		Thread resolveThread = new Thread(new Runnable() {
			...
			public void run() {
				...
				for (final AnimationJob job : object.getJobList()) {
